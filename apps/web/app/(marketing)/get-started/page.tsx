...
export default function GetStartedPage() {
  ...
  const categories = [
    { name: t("categories.hiking"), label: t("landing.categoryHikingLabel"), image: "https://images.unsplash.com/photo-1501555088652-021faa106b9b?w=1200&q=82&fit=crop&auto=format" },
    { name: t("categories.mountaineering"), label: t("landing.categoryMountainLabel"), image: "https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?w=1200&q=82&fit=crop&auto=format" },
    { name: t("categories.waterSports"), label: t("landing.categoryWaterLabel"), image: "https://images.unsplash.com/photo-1530053969600-caed2596d242?w=1200&q=82&fit=crop&auto=format" },
    { name: t("categories.cycling"), label: t("landing.categoryCyclingLabel"), image: "https://images.unsplash.com/photo-1541625602330-2277a4c46182?w=1200&q=82&fit=crop&auto=format" },
    { name: t("categories.motorsport"), label: t("landing.categoryMotorsportLabel"), image: "https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=1200&q=82&fit=crop&auto=format" },
    { name: t("categories.running"), label: t("landing.categoryRunningLabel"), image: "https://images.unsplash.com/photo-1571008887538-b36bb32f4571?w=1200&q=82&fit=crop&auto=format" },
    { name: t("categories.winterSports"), label: t("landing.categoryWinterLabel"), image: "https://images.unsplash.com/photo-1491002052546-bf38f186af56?w=1200&q=82&fit=crop&auto=format" },
    { name: t("categories.expedition"), label: t("landing.categoryExpeditionLabel"), image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&q=82&fit=crop&auto=format" },
  ];
    ...
    <main className="min-h-screen bg-canvas text-ink">
      ...
      <section className="border-b border-line bg-canvas" data-testid="landing-hero">
        <div className={`${SECTION} grid items-center gap-10 lg:min-h-[680px] lg:grid-cols-[1.12fr_0.88fr] lg:gap-20`}>
          ...
          <Image src="https://images.unsplash.com/photo-1565992441121-4367c2967103?w=1200&q=82&fit=crop&auto=format" alt="" width={480} height={580} priority sizes="(min-width: 1024px) 40vw, 100vw" className="h-[420px] w-full object-cover sm:h-[520px] lg:h-[580px]" />
        </div>
      </section>
      ...
      <section id="features" className="border-b border-line bg-canvas">
        <div className={SECTION}>
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-[1.65fr_0.9fr]">
            <article>
              <Image src="https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1600&q=82&fit=crop&auto=format" alt="" width={840} height={520} sizes="(min-width: 1024px) 60vw, 100vw" className="h-[380px] w-full object-cover sm:h-[520px]" />
