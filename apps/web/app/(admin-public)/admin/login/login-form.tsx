          ...
          <form action={formAction} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                autoComplete="email"
                className="w-full bg-[#0F172A] border border-white/10 rounded-lg px-3.5 py-2.5 text-white text-sm placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition-colors"
              />
            </div>
